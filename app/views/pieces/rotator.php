            ...
            <div class="thumbnails">
                <ul>
					...
					<li>
						...
						<a href="<?=$this->uri->sef('home/index/11')?>" ></a>
						 <p style="top:90px; left:3px; width:163px; height:auto">
                            Cena izolace je včetně práce
                       	</p>
                    </li>
					 <li>
                    	<a href="<?=PATH?>rotator/i01.jpg" title=""></a>
						<p style="top:3px; left:3px; width:183px; height:auto">
                            Climatizer Plus je vhodný izolant všech částí konstrukce
                       	</p>
                    </li>
					 <li>
					 ...
					 <li>
                    	<a href="<?=PATH?>rotator/i05.jpg" title=""></a>
                    </li>
					<li>
